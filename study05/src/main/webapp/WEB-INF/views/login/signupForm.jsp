	...
	<article>
		<div class="container col-md-6" role="main">
			<div class="card">
				...
				<div class="card-body">
					<form:form name="form" id="form" class="form0signup" role="form" modelAttribute="userVO" method="post" action="${path }/user/insertUser">
						<div class="form-group row">
							<label for="uid" class="col-md-3 col-form-label text-md-right">아이디</label>
							<div class="col-md-5">
								<form:input path="uid" id="uid" class="form-control" placeholder="아이디를 입력해주세요."/>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<form:input path="name" id="name" class="form-control" placeholder="이름을 입력해주세요."/>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<form:password path="pwd" id="pwd" class="form-control" placeholder="비밀번호를 입력해주세요."/>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<form:password path="re_pwd" id="re_pwd" class="form-control" placeholder="비밀번호를 입력해주세요."/>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="input-group col-md-7">
								...
								<form:input path="email" id="email" class="form-control" placeholder="이메일을 입력해주세요."/>
							</div>
						</div>
					</form:form>
				</div>
